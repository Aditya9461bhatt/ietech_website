          ...
          {RESTAURANT_RAIL_ICONS.map((Icon, index) => (
            <button
              ...
              className={`grid w-full place-items-center rounded-sm p-1 ${activeRail === index
                ...
                : 'text-[#7a8597] transition-colors dark:text-[#8b949e]'
                }`}
            >
      ...
      <div className="flex h-full min-w-0">
        <div className="flex-1 p-2.5 flex flex-col">
          <div className="flex justify-between items-center mb-2">
            <p className="text-[10px] text-[#667487] dark:text-[#8b949e] font-semibold">/ Point of Sale / Main Menu</p>
            <div className="flex gap-1">
              <button className="bg-[#e7edf7] text-[#30435e] dark:bg-[#1c2333] dark:text-[#c9d1d9] px-1.5 py-0.5 rounded-sm text-[8px]">Food</button>
              <button className="text-[#7787a0] dark:text-[#8b949e] px-1.5 py-0.5 rounded-sm text-[8px]">Drinks</button>
            </div>
          </div>
          
          <div className="grid grid-cols-2 gap-2 mt-2">
            {items.map((item, i) => (
              <div key={i} className="rounded-sm border border-[#dce2ec] bg-white p-2 dark:border-[#21262d] dark:bg-[#161b22] flex flex-col justify-between">
                <p className="text-[10px] font-medium text-[#2e3645] dark:text-[#e6edf3]">{item.name}</p>
                <div className="flex justify-between items-end mt-2">
                  <p className="text-[9px] text-[#ea580c] font-semibold">{item.price}</p>
                  <div className="h-4 w-4 bg-[#f0f2f6] dark:bg-[#21262d] rounded-sm flex items-center justify-center">
        ...
        <div className="w-[120px] bg-white dark:bg-[#161b22] border-l border-[#e0e4ea] dark:border-[#21262d] flex flex-col shrink-0">
          <div className="p-2 border-b border-[#e0e4ea] dark:border-[#21262d]">
            <p className="text-[9px] font-semibold text-[#2e3645] dark:text-[#e6edf3]">Current Order</p>
            <p className="text-[7px] text-[#7a8597] dark:text-[#8b949e]">Table 12 · Dine In</p>
          </div>
          ...
          <div className="flex-1 p-2 space-y-2">
            {[...Array(cartCount || 1)].map((_, i) => (
              <div key={i} className="flex justify-between items-center">
                <div>
                  <p className="text-[8px] text-[#2e3645] dark:text-[#e6edf3] truncate max-w-[60px]">{items[i % 4].name}</p>
                  <p className="text-[7px] text-[#7a8597] dark:text-[#8b949e]">1 x {items[i % 4].price}</p>
                </div>
                <p className="text-[8px] font-semibold text-[#2e3645] dark:text-[#e6edf3]">{items[i % 4].price}</p>
              </div>
            ))}
          </div>

          <div className="p-2 bg-[#f4f5f8] dark:bg-[#0d1117] mt-auto">
            <div className="flex justify-between items-center mb-1">
              <p className="text-[8px] text-[#7a8597] dark:text-[#8b949e]">Total</p>
...
function KitchenScene() {
  ...
  return (
    <div className="grid h-full grid-cols-[34px_minmax(0,1fr)] bg-[#f7f8fa] dark:bg-[#0d1117]">
      ...
      <div className="p-2.5">
        <div className="flex justify-between items-center mb-2">
          <p className="text-[10px] text-[#667487] dark:text-[#8b949e] font-semibold">/ Kitchen Display / Orders</p>
        ...
        <div className="grid grid-cols-2 gap-2">
          <div className="rounded-sm border border-[#eab308]/50 bg-white dark:bg-[#161b22] dark:border-[#eab308]/30 overflow-hidden">
            ...
            <div className="p-2 space-y-1.5">
              <div className="flex items-start gap-1">
                <span className="text-[9px] font-bold text-[#2e3645] dark:text-[#e6edf3]">1x</span>
                <span className="text-[9px] text-[#4b5563] dark:text-[#9ca3af]">Caesar Salad (No Croutons)</span>
              </div>
              <div className="flex items-start gap-1">
                <span className="text-[9px] font-bold text-[#2e3645] dark:text-[#e6edf3]">2x</span>
          ...
          <div className="rounded-sm border border-[#dce2ec] bg-white dark:bg-[#161b22] dark:border-[#21262d] overflow-hidden">
            <div className="bg-[#f3f4f6] dark:bg-[#1f2937] p-1.5 flex justify-between items-center border-b border-[#e5e7eb] dark:border-[#374151]">
  ...
  return (
    <div className="grid h-full grid-cols-[34px_minmax(0,1fr)] bg-[#f7f8fa] dark:bg-[#0d1117]">
      ...
      <div className="p-2.5 flex flex-col">
        <p className="text-[10px] text-[#667487] dark:text-[#8b949e] font-semibold mb-2">/ Inventory / Low Stock</p>
        ...
        <div className="grid grid-cols-3 gap-1.5 mb-2">
          {['Tomatoes (kg)', 'Mozzarella (kg)', 'Flour (kg)'].map((label, i) => (
             <div key={label} className="rounded-sm border border-[#dce2ec] bg-white px-2 py-1.5 dark:border-[#21262d] dark:bg-[#161b22]">
               ...
               <p className={`mt-0.5 text-[11px] font-semibold ${i === 0 ? 'text-[#ef4444]' : 'text-[#2e3645] dark:text-[#e6edf3]'}`}>
                 {i === 0 ? '2.5 / 10' : '15.0 / 20'}
               </p>
             </div>
          ))}
        ...
        <div className="flex-1 rounded-sm border border-[#dce2ec] bg-white p-2 dark:border-[#21262d] dark:bg-[#161b22]">
           <div className="flex justify-between items-center border-b border-[#e5e7eb] dark:border-[#374151] pb-1 mb-1">
