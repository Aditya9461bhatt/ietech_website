...
export function GoogleGeminiEffect({
  ...
  return (
    <div
      className={cn(
        'relative h-full min-h-[340px] overflow-hidden rounded-sm border border-[#cad4e4] bg-gradient-to-br from-[#edf4ff] via-[#f7faff] to-[#ffffff] shadow-[0_20px_42px_rgba(24,54,93,0.15)] dark:border-white/10 dark:bg-gradient-to-br dark:from-[#040a15] dark:via-[#050d19] dark:to-[#02060d] dark:shadow-[0_28px_60px_rgba(6,15,32,0.42)]',
        className,
      )}
    >
