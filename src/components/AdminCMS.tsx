...
export default function AdminCMS({ type, editId, onBack }: AdminCMSProps) {
  ...
  if (!ALLOWED_ADMIN_EMAILS.includes(user.email || '')) {
    return (
      <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-8">
        ...
        <p className="text-neutral-600 dark:text-neutral-400 mb-8">Your account ({user.email}) is not authorized to access the CMS.</p>
        <div className="flex gap-4">
          <button 
            ...
            className="px-6 py-3 border border-red-500 text-red-500 font-bold uppercase tracking-wider text-xs hover:bg-red-500 hover:text-neutral-900 dark:text-white transition-colors"
          >
            Sign Out
          </button>
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#0a0a0a] text-neutral-900 dark:text-white font-sans flex flex-col overflow-hidden h-screen">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="w-1/2 flex flex-col border-r border-neutral-800 bg-[#111] overflow-y-auto p-6 custom-scrollbar">
          <h2 className="text-sm font-bold uppercase tracking-widest text-neutral-600 dark:text-neutral-500 mb-6">Metadata</h2>
          
          <div className="grid grid-cols-2 gap-4 mb-6">
            <div>
              <label className="block text-[10px] uppercase tracking-widest text-neutral-600 dark:text-neutral-500 mb-1">URL Slug (ID)</label>
            ...
            <div>
              <label className="block text-[10px] uppercase tracking-widest text-neutral-600 dark:text-neutral-500 mb-1">Date</label>
            ...
            <div className="col-span-2">
              <label className="block text-[10px] uppercase tracking-widest text-neutral-600 dark:text-neutral-500 mb-1">Title</label>
            ...
            {type === 'case_study' && (
              <>
                <div>
                  <label className="block text-[10px] uppercase tracking-widest text-neutral-600 dark:text-neutral-500 mb-1">Client Name</label>
                ...
                <div>
                  <label className="block text-[10px] uppercase tracking-widest text-neutral-600 dark:text-neutral-500 mb-1">Industry</label>
                ...
                <div className="col-span-2">
                  <label className="block text-[10px] uppercase tracking-widest text-neutral-600 dark:text-neutral-500 mb-1">Short Description (Grid View)</label>
            ...
            {type === 'blog' && (
              <>
                <div>
                  <label className="block text-[10px] uppercase tracking-widest text-neutral-600 dark:text-neutral-500 mb-1">Category</label>
                ...
                <div className="col-span-2">
                  <label className="block text-[10px] uppercase tracking-widest text-neutral-600 dark:text-neutral-500 mb-1">Excerpt (Short Summary)</label>
            ...
            <div>
              <label className="block text-[10px] uppercase tracking-widest text-neutral-600 dark:text-neutral-500 mb-1">Author Name</label>
            ...
            <div>
              <label className="block text-[10px] uppercase tracking-widest text-neutral-600 dark:text-neutral-500 mb-1">Author Email</label>
            ...
            <div className="col-span-2">
              <label className="block text-[10px] uppercase tracking-widest text-neutral-600 dark:text-neutral-500 mb-1">Cover Image URL</label>
          ...
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-sm font-bold uppercase tracking-widest text-neutral-600 dark:text-neutral-500">Markdown Content</h2>
          ...
          <textarea 
            ...
            className="w-full flex-1 min-h-[400px] bg-black border border-neutral-800 text-neutral-700 dark:text-neutral-300 p-4 text-sm font-mono focus:border-[#3F618C] outline-none resize-y"
          />
        </div>
        ...
        <div className="w-1/2 bg-black overflow-y-auto custom-scrollbar">
          <div className="p-8 pb-32 max-w-4xl mx-auto">
            ...
            <h1 className="text-3xl md:text-5xl font-black tracking-tight text-neutral-900 dark:text-white mb-6 text-center mx-auto leading-[1.1]">
              {formData.title || "Untitled Document"}
            </h1>
            
            <div className="flex items-center justify-center gap-4 text-xs md:text-sm font-bold tracking-widest uppercase text-neutral-600 dark:text-neutral-400 mb-12">
            ...
            {type === 'case_study' ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
                <div className="md:col-span-1">
                  ...
                  <p className="text-sm font-bold text-neutral-900 dark:text-white mb-4">{formData.authorName}</p>
